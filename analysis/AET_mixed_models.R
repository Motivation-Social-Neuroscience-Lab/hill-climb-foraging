...
if (model_number== ''){ # if running statistics on real subject data (we don't have reward variables for simulated data)
  for (i in unique(behav$subjectNumber)){
...
#write_csv(behav, paste('../../data_derived/',task_version,'/cleaned_behav_summary_',model_number, task_version,'.csv', sep = ""))
...
models_compare[1:14,]$rand_effects_structure <- c(
  # removing correlations
  '(1 + blockType*averageEffortRate_scaled|subjectNumber) + (1 + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType + averageEffortRate_scaled|subjectNumber) + (1 + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType +  blockType:averageEffortRate_scaled|subjectNumber) + (1 + trialNinBlock_scaled + responseHistory + blockN_scaled + averageEffortRate_scaled||subjectNumber)',
  '(1 + averageEffortRate_scaled + blockType:averageEffortRate_scaled|subjectNumber) + (1 + blockType + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType|subjectNumber) + (1 + averageEffortRate_scaled + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + averageEffortRate_scaled|subjectNumber) + (1 + blockType + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType + averageEffortRate_scaled + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',

  # removing random intercepts
  '(1 + blockType + averageEffortRate_scaled + blockType:averageEffortRate_scaled|subjectNumber) + (0 + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType + averageEffortRate_scaled|subjectNumber) + (0 + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType + blockType:averageEffortRate_scaled|subjectNumber) + (0 + trialNinBlock_scaled + responseHistory + blockN_scaled + averageEffortRate_scaled||subjectNumber)',
  '(1 + averageEffortRate_scaled + blockType:averageEffortRate_scaled|subjectNumber) + (0 + blockType + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + blockType|subjectNumber) + (0 + averageEffortRate_scaled + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(1 + averageEffortRate_scaled|subjectNumber) + (0 + blockType + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)',
  '(0 + blockType + averageEffortRate_scaled + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled||subjectNumber)'
)
...
for (i in 1:nrow(models_compare)) {
  ...
  random_effects <- models_compare$rand_effects_structure[i]
  formula_str <- paste(
    "response ~ blockType + averageEffortRate_scaled + blockType:averageEffortRate_scaled + trialNinBlock_scaled + responseHistory + blockN_scaled + ",
    random_effects
  )
...
model_7 <- glmmTMB(response ~ blockType + averageEffortRate_7_scaled + blockType:averageEffortRate_7_scaled +  
  trialNinBlock_scaled + responseHistory + blockN_scaled +  
  (1 + blockType | subjectNumber) + (0 + averageEffortRate_7_scaled +  
                                       blockType:averageEffortRate_7_scaled + trialNinBlock_scaled +  
                                       responseHistory + blockN_scaled || subjectNumber),
...
# avg_eff_model <- results[[models_compare$model_num[which.min(models_compare$AIC)]]]
# save(results, avg_eff_model, models_compare, file = paste0('glmm_output/glm_model_avg_effort_', model_number, task_version, '.RData'))
