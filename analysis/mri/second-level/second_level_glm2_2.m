...
all_modulator = {'value', 'backgroundEffort', 'unsigned_effortPE', 'decision'};
n_contrast = length(all_modulator);

path = [sys_path, 'first_level/z_6m_csf_wm_compcor_M1_fit_MAP/glm2_2/sub-'];

for c = 1:n_contrast

    c
    con_path = [sys_path,  'second_level/z_6m_csf_wm_compcor_M1_fit_MAP/glm2_2/con000',num2str(c)];
    mkdir(con_path);
