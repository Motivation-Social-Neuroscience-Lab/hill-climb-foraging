...
path = [sys_path, 'first_level/z_6m_csf_wm_compcor_M1_fit_MAP/glm2_1/sub-'];

for c = 1:n_contrast

    c
    con_path = [sys_path,  'second_level/z_6m_csf_wm_compcor_M1_fit_MAP/glm2_1/con000',num2str(c)];
    mkdir(con_path);
