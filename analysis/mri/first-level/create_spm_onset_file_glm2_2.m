...
% Emma Scholey
% 17 Dec 2024
% This looks at pursue/reject decision
clearvars; close all
...
for i = 1:length(matFiles)
    ...
    pmod(1).name{4} = 'decision'; 
    pmod(1).param{4} = modelEstimates.response(keepIdx);
    pmod(1).poly{4} = 1;
    ...
    save_onsets_dir = '/Volumes/appsmaj-effort-prey-fmri-scholey/aet_fMRI/first_level/z_6m_csf_wm_compcor_M1_fit_MAP/glm2_2/sub-';
