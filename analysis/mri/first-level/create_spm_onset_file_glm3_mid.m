...
% Emma Scholey
% 3 Oct 2025
% create condition onset and pmod files for glm 2 - test parametric
% modulators tgether - rejected trials. Mid level effort only
clearvars; close all
...
name_subj = [101, 104, 108, 110, 112:114, 119, 121, 125, 126, 128, 129, 133, 136:138, 140]; % The file (subject) numbers of the files to be used in the analysis
...
for i = 1:length(matFiles)
    ...
    save_onsets_dir = '/Volumes/appsmaj-effort-prey-fmri-scholey/aet_fMRI/first_level/z_6m_csf_wm_compcor_M1/glm3_mid/sub-';
