...
data_folder = '/Volumes/appsmaj-effort-prey-fmri-scholey/aet_fMRI/';

%%% Subject IDs
subj = [1, 4, 8, 10, 12:14, 19, 21, 25, 26, 28, 29,33, 36:38, 40]; % The file (subject) numbers of the files to be used in the analysis
...
for i = 1:numel(subj)
    ...
    path = [data_folder, 'first_level/z_6m_csf_wm_compcor_M1/glm3_mid/sub-'];
    dir_output = [path,id];
    cd(dir_output)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.multi_reg = {['../../../../preprocessed/sub-', id,'/func/nuisance_regressors_csf_wm_compcor_6m-',id,'.mat']};
    ...
    % matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'REJECT_value';
    % matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 1];
    % matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

    matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'REJECT_background_effort';
    matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [0 1];
    matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

    % matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'REJECT_unsigned_effortPE';
    ...
    % save(fullfile(dir_output, 'glm1.mat'), 'matlabbatch')
