...
for i = 1:length(subject_numbers)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.dir = {['/Users/proghani/Documents/personal/local_thesis_folder/fMRI/main/bids_fmri_data/sub-', subj_num,'/derivatives/first_level/glm1']};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess.multi = {['/Users/proghani/Documents/personal/local_thesis_folder/fMRI/main/bids_fmri_data/sub-', subj_num,'/conditions_onsets_background_effort_pmod.mat']};
    ...
    % fprintf('Number of conditions:', length(matlabbatch{1}.spm.stats.fmri_spec.sess.cond));
    % display the contents of matlabbatch{1}.spm.stats.fmri_spec.sess.cond
    % disp('Contents of matlabbatch{1}.spm.stats.fmri_spec.sess.cond:');
    % disp(matlabbatch{1}.spm.stats.fmri_spec.sess.cond);
    ...
    matlabbatch{3}.spm.stats.con.spmmat(1) = cfg_dep('Model estimation: SPM.mat File', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
    matlabbatch{3}.spm.stats.con.consess{1}.fcon.name = 'backgroundEffPmod';
