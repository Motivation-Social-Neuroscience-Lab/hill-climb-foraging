...
excl_subj = [103,106,139];
name_subj = setdiff(name_subj,excl_subj);
...
for i = 1:length(matFiles)
    ...
    save_onsets_dir = '/Volumes/appsmaj-effort-prey-fmri-scholey/aet_fMRI/first_level/z_6m_csf_wm_compcor_M1_fit_MAP_v2/glm2_1_excl/sub-';
